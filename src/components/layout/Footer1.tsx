    ...
    <footer className="py-12">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-10 text-center md:text-left">
          {/* Left Side - Social */}
          <div className="space-y-6 w-full flex flex-col items-center pr-24 md:items-start">
            <a
          ...
          {/* Center Logo */}
          <div className="text-center pr-8 md:pr-0  md:mb-0">
          ...
          <div className="space-y-6">
            ...
            <div className="hidden md:flex flex-col space-y-6">
              <div className="flex flex-row-reverse items-start justify-start gap-3">
                <Phone className="text-red-500 mt-1" size={20} />
                <div className="leading-tight text-left md:text-right">
                  <p className="font-medium whitespace-nowrap">Telephone</p>
